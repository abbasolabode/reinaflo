  ...
  return (
    <div style={bgHeroImage} className="px-4 min-h-screen flex flex-col justify-center items-center gap-10 space-y-9 ">
        <div className="flex flex-col gap-3 items-center justify-center">
            ...
            <p className='font-light text-center text-white'>Our mission, both then and now is to provide quality education while upholding the highest standard of integrity, professionalism and student success.</p>
        </div>

        <h1 className='font-bold text-4xl justify-center items-center text-white md:text-5xl lg:text-6xl'>About</h1>
    </div>
  )
}
