...
export default function Mission() {
    return (
        <div className="w-full flex-col px-4 min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 ">
            {/* Left container */}
            ...
            <section className="space-y-8 lg:col-start-1 lg:row-start-1">
                ...
                <div className="flex flex-col gap-4">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 leading-tight tracking-tight group-hover:from-blue-800/80 group-hover:to-blue-900 group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 delay-1100 opacity-100 translate-y-0">Our Mission</h2>
                    ...
                    <p className="text-base text-gray-700 leading-relaxed font-light border-l-2 border-gray-200 pl-6 group-hover:border-blue-400 transition-all duration-300 delay-1400 opacity-100 translate-y-0">We are driven by a passion for grooming each child's uniqueness, ensuring comprehensive development through structured policies, curriculum, and extra-curricular activities that showcase international standards.</p>
                </div>
