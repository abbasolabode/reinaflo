...
const special = [
    {
        ...
        icon: <IoMdBook size={10} className="w-6 h-6 rounded-full text-white bg-blue-700" />,
    },
    {
        id: 2,
        text: "Leadership Architects",
        icon: <HiUsers size={10} className="w-6 h-6 rounded-full text-white bg-blue-700" />
    },

    {
        id: 3,
        text: "Human Transformation",
        icon: <FaHeart size={10} className="w-6 h-6 rounded-full text-white bg-blue-700" />
    },
    {
        id: 4,
        text: "Global Excellence Standards",
        icon: <GiAchievement size={10} className="w-6 h-6 rounded-full text-white bg-blue-700" />
    },
]
...
const approach = [
    {
        id: 1,
        icon: <GoDotFill className="w-2 h-2 rounded-full bg-blue-600 shrink-0 mt-2 hover:scale-150 transition-all duration-300 delay-1200" />,
...
export default function Story() {
    return (
        <div className="shadow-lg shadow-white min-h-screen z-50 flex flex-col gap-5 space-y-6 pb-6 px-4">
            {/* Left container */}
            <section className="flex flex-col gap-16">
                <div className="flex space-x-6 items-center">
                    <hr className="bg-linear-to-r from-blue-800 to-blue-800 h-px transition-all duration-300 delay-200 w-12" />
                    <h4 className="text-sm font-medium text-blue-700"> About Our School</h4>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <p className="text-lg leading-relaxed font-light bg-linear-to-r from-neutral-900 via-blue-800 to-neutral-900 bg-clip-text text-transparent transition-all duration-300 delay-700 opacity-100 translate-y-0">
                    ...
                    <div className="bg-blue-50/50 rounded p-6 border-l-4 border-blue-700 hover:translate-x-2 hover:border-l-8 opacity-100 translate-y-0">
                ...
                <div className="flex flex-col space-y-5 ">
                    <h3 className="text-xl font-semibold  text-blue-600">What Makes Us Special</h3>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {special.map(item => (
                            <div key={item.id} className="flex items-center gap-2 shrink-0 group:hover:scale-125 group:hover:rotate-180 duration-300 transition-all"> {item.icon} <p className="bg-linear-to-r from-neutral-900 via-blue-800 to-neutral-900 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-blue-700 transition-all duration-200 font-medium ">{item.text}</p></div>
                        ))}
                    </div>
                </div>
                ...
                <div className="w-full space-y-4 transition-all duration-300 delay-1000 opacity-100 translate-y-0">
                    <h4 className="text-lg font-medium text-blue-800">Our Educational Approach</h4>
                    {approach.map(item => (
