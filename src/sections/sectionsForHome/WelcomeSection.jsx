    ...
    return (
        <div className="px-4 lg:px-8 py-5 z-50 min-h-screen w-full flex flex-col gap-12 lg:grid lg:grid-cols-2 lg:gap-24">
            ...
            <section className='lg:max-w-120 min-h-screen flex flex-col gap-8 w-full'>
                ...
                <p className="text-sm font-medium text-gray-800">"Knowledge for Excellence and Service"</p>
                <div className="space-y-6 w-full ">
                    <p className="text-gray-700 text-lg leading-relaxed">Reina-Flor Okori Makendengue is a four-time Olympian, strategist, and change architect working at the intersection of high performance, leadership, and human development.</p>

                    <p className="text-gray-700 text-lg leading-relaxed"> Competing at the highest level in track and field for both France and Equatorial Guinea, she is among the fastest women in French history in the 100m hurdles. Her career—spanning over two decades—reflects discipline, resilience, and the ability to perform under pressure at the highest level.
                    </p>
                ...
                <Link to="/about" className=" bg-black px-8 py-4 font-medium hover:bg-blue-700 transition-all duration-700 shadow-lg text-white flex items-center whitespace-nowrap gap-3 w-70">Learn More About ReinaFlor < GoArrowRight size={20} /></Link>
            </section>
